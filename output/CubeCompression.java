...
public class CubeCompression {
    public static void main(String[] args) throws Exception {
        File csvFile = new File("excel_data3.csv");
        ...
        areaAvg.setCellStyle(numberStyle);
        ...
        weightAvg.setCellStyle(numberStyle);
        ...
        densityAvg.setCellStyle(numberStyle);
        ...
        forceAvg.setCellStyle(numberStyle);
        ...
        strengthAvg.setCellStyle(numberStyle);
        ...
        // Output file
        try (FileOutputStream out = new FileOutputStream("cube_compression.xlsx")) {
            workbook.write(out);
        }
        workbook.close();

        System.out.println("XLSX created with data from CSV.");
    }
}
